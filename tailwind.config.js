    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                'green-glow': '0 0 32px rgba(0,153,255,0.35), 0 0 12px rgba(0,153,255,0.20)',
                'green-sm': '0 0 16px rgba(0,153,255,0.25)',
            ...
            backgroundImage: {
                'hero-gradient': 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(255,255,255,0.08) 0%, transparent 70%), radial-gradient(ellipse 60% 50% at 80% 20%, rgba(0,153,255,0.06) 0%, transparent 60%)',
                'glass-card': 'linear-gradient(135deg, rgba(30,30,35,0.7) 0%, rgba(15,15,18,0.4) 100%)',
                'green-gradient': 'linear-gradient(135deg, #0099FF 0%, #007ACC 100%)',
                'dark-gradient': 'linear-gradient(180deg, #1C1C1A 0%, #000000 100%)',
                'section-glow': 'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(0,153,255,0.06) 0%, transparent 70%)',
